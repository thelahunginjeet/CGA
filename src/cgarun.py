...
def run_cga():
    ...
    mySim = CGASimulation.CGASimulation(databaseFile=proteinDBFileName, pdbFile=pdbFileName, fitnessMethod='weighted_accuracy', forestSize=50, treeGenDict={'treetype':'fixed','p':15,'r':0.5})
